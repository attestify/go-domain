...
// RegistrationGateway is the interface which defines the behaviors expected when invoking a gateway
// implementation for the public domain registration usecase.
type RegistrationGateway interface {
	 RegisterPublicDomain(publicDomain public_domain_entity.PublicDomain) error
}
